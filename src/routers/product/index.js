...
router.put("/published/:id", asyncHandler(productController.publishProductForShop))
router.put("/unPublished/:id", asyncHandler(productController.unPublishProductForShop))
